...
public class TC33 {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		String amount=ExcelUtility.getDataFromExcel("TC33", 0, 1);
		...
		//driver.findElement(By.name("lastname")).sendKeys("rag");
		...
		//driver.findElement(By.name("amount")).sendKeys("tybvkjbfkh");
