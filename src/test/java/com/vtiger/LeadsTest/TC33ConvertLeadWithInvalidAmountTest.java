...
public class TC33ConvertLeadWithInvalidAmountTest extends BaseClass{
	String lastname;
	String companyname;
	String closingdate;
	String amount;
	...
	@Test
	public void TC33ConvertLeadWithInvalidAmountTest() throws EncryptedDocumentException, IOException, InterruptedException {
		...
		companyname=ExcelUtility.getDataFromExcel("TC31", 2, 1)+randomNumber;
		 ...
		 amount=ExcelUtility.getDataFromExcel("TC33", 0, 1)+randomNumber;
